...
const Navbar = () => {
  ...
  return (
    <nav className="h-screen w-20 bg-gray-900 text-white flex flex-col justify-between items-center py-6">
      <AppIcon />
      ...
      {/*Remainder: This is made inorder to center the navlinks, not to be removed*/}
      <div></div>

      <button
        onClick={() => setIsOpen(!isOpen)}
        className="md:hidden p-2 rounded-md text-gray-400 hover:bg-gray-700 mx-auto"
      >
        <Menu size={24} />
      </button>
    </nav>
...
const AppIcon = () => {
  ...
  return (
    ...
    >
      {/*Remainder: positioning difficult workaroundd*/}
